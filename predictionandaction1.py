...
model.setInputSize(320, 320)  # Try reducing this if it's too slow
...
confThreshold = 0.3  # Reduce the confidence threshold for better detection
...
while True:
    ...
    if len(class_index) > 0:
        for class_ind, conf, boxes in zip(class_index.flatten(), confidence.flatten(), bbox):
            ...
            detected_object = classlabels[class_ind - 1]
            ...
            label = (f'{detected_object}: {color_name}, Conf: {conf * 100:.2f}%, '
